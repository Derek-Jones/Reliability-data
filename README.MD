...
The system is a PL/I database application software consisting of approximately 1,317,000 lines of code.  Each row cntains cumulative faults/CPU time for consecutive elapsed weeks.
